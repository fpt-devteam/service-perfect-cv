...
{
    public class SectionRubricService

    {
        ...
        public SectionRubricService(ILogger<SectionRubricService> logger, Kernel kernel, IOptions<SemanticKernelOptions> options, IJsonHelper jsonHelper)
        {
            _logger = logger;
            _kernel = kernel;
