...
namespace ServicePerfectCV.Infrastructure.Services.AI.SemanticKernel
{
    public static class PromptManager
    {
        public static string GetPrompt(PromptType promptType)
        {
            ...
            {
                PromptType.JobRubric => GetJobRubricPrompt(),
        ...
        #region Job Rubric Prompt

        private static string GetJobRubricPrompt()
        {
            return """
        ...
        You MUST return a JSON object with exactly this structure: (content below is illustrative, not literal)
        {
        "contact": {
            "criteria": [
            {
                ...
                "weight": 0.6,
                "scoring": {
                "0": "Missing or unprofessional contact info",
                "1": "Basic contact info present",
                "2": "Standard professional contact",
                "3": "Well-formatted professional contact",
                "4": "Comprehensive professional contact",
                "5": "Exceptional professional presentation"
                }
            }
            ]
        },
        ...
        "skills": {
            "criteria": [
            { /* Same structure as above */ },
            { /* Additional criteria up to 4 max */ }
            ]
        },
        "experience": {
            "criteria": [
