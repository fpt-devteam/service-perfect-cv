...
{
    public class SectionScoreService : ISectionScoreService
    {
        ...
        public SectionScoreService(ILogger<SectionScoreService> logger, Kernel kernel, IOptions<SemanticKernelSettings> options, IJsonHelper jsonHelper)
        {
            _logger = logger;
            _kernel = kernel;
