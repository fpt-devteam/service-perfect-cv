    ...
    res.json({
        ...
        endpoints: {
            cv: {
                ...
                'POST /api/cv/:cvId/apply-suggestion':
                    'Apply improvement suggestion',
                'POST /api/cv/:cvId/reanalyze':
                    'Reanalyze CV with updated content',
            ...
            qa: {
                ...
                'POST /api/qa/session/:sessionId/close':
                    'Close conversation session',
                'GET /api/qa/user/:userId/sessions': 'Get user sessions',
                'GET /api/qa/user/:userId/analytics':
                    'Get conversation analytics',
            },
            feedback: {
                'GET /api/feedback/user/:userId/history':
                    'Get feedback history',
                'GET /api/feedback/user/:userId/dashboard':
                    'Get progress dashboard',
                'POST /api/feedback/user/:userId/apply-suggestion':
                    'Apply suggestion to history',
                'GET /api/feedback/user/:userId/analytics':
